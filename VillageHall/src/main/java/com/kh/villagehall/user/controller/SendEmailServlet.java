...
public class SendEmailServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		String fromEmail = "administrator@villagehall.com"; // 보내는  사람으로 표시될 이메일

		String fromUsername = "마을회관"; // 보내는 사람 이름
		
		String toEmail = inputEmail; // 받는사람
		
		final String smtpEmail = "kjyoon811@gmail.com"; // 이메일
		final String password = "ugmyjqxrzimkxyof"; 
